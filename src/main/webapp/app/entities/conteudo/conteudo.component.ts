...
export class ConteudoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.conteudoService
      ...
      .subscribe(
        (res: HttpResponse<IConteudo[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInConteudos(): void {
    this.eventSubscriber = this.eventManager.subscribe('conteudoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IConteudo[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
