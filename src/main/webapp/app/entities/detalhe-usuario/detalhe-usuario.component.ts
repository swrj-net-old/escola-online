...
export class DetalheUsuarioComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.detalheUsuarioService
      ...
      .subscribe(
        (res: HttpResponse<IDetalheUsuario[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDetalheUsuarios(): void {
    this.eventSubscriber = this.eventManager.subscribe('detalheUsuarioListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDetalheUsuario[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
