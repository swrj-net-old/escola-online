...
export class HistoricoDebitoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.historicoDebitoService
      ...
      .subscribe(
        (res: HttpResponse<IHistoricoDebito[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInHistoricoDebitos(): void {
    this.eventSubscriber = this.eventManager.subscribe('historicoDebitoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IHistoricoDebito[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/historico-debito'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
