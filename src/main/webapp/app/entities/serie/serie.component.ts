...
export class SerieComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.serieService
      ...
      .subscribe(
        (res: HttpResponse<ISerie[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInSeries(): void {
    this.eventSubscriber = this.eventManager.subscribe('serieListModification', () => this.loadPage());
  }
