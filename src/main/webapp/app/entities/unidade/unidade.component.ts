...
export class UnidadeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.unidadeService
      ...
      .subscribe(
        (res: HttpResponse<IUnidade[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInUnidades(): void {
    this.eventSubscriber = this.eventManager.subscribe('unidadeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IUnidade[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
