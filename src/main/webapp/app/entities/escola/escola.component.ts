...
export class EscolaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.escolaService
      ...
      .subscribe(
        (res: HttpResponse<IEscola[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInEscolas(): void {
    this.eventSubscriber = this.eventManager.subscribe('escolaListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IEscola[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
