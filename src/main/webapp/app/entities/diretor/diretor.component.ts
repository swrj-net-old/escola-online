...
export class DiretorComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.diretorService
      ...
      .subscribe(
        (res: HttpResponse<IDiretor[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDiretors(): void {
    this.eventSubscriber = this.eventManager.subscribe('diretorListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDiretor[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
