...
export class AlunoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.alunoService
      ...
      .subscribe(
        (res: HttpResponse<IAluno[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IAluno[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
