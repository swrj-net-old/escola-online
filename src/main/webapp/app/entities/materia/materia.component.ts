...
export class MateriaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.materiaService
      ...
      .subscribe(
        (res: HttpResponse<IMateria[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInMaterias(): void {
    this.eventSubscriber = this.eventManager.subscribe('materiaListModification', () => this.loadPage());
  }
