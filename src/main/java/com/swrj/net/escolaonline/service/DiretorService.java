...
public class DiretorService {
    ...
    /**
     * Partially update a diretor.
     *
     * @param diretor the entity to update partially.
     * @return the persisted entity.
     */
    public Optional<Diretor> partialUpdate(Diretor diretor) {
        log.debug("Request to partially update Diretor : {}", diretor);
