...
public class ChamadaService {
    ...
    /**
     * Partially update a chamada.
     *
     * @param chamada the entity to update partially.
     * @return the persisted entity.
     */
    public Optional<Chamada> partialUpdate(Chamada chamada) {
        log.debug("Request to partially update Chamada : {}", chamada);
