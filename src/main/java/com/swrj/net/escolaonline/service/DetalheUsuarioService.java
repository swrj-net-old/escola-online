...
public class DetalheUsuarioService {
    ...
    /**
     * Partially update a detalheUsuario.
     *
     * @param detalheUsuario the entity to update partially.
     * @return the persisted entity.
     */
    public Optional<DetalheUsuario> partialUpdate(DetalheUsuario detalheUsuario) {
        log.debug("Request to partially update DetalheUsuario : {}", detalheUsuario);

        return detalheUsuarioRepository
