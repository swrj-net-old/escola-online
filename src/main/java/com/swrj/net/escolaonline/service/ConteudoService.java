...
public class ConteudoService {
    ...
    /**
     * Partially update a conteudo.
     *
     * @param conteudo the entity to update partially.
     * @return the persisted entity.
     */
    public Optional<Conteudo> partialUpdate(Conteudo conteudo) {
        log.debug("Request to partially update Conteudo : {}", conteudo);
