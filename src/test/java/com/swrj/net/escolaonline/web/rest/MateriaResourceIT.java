...
public class MateriaResourceIT {
    ...
    public void createMateria() throws Exception {
        ...
        // Create the Materia
        restMateriaMockMvc
            .perform(post("/api/materias").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(materia)))
    ...
    public void getAllMaterias() throws Exception {
        ...
        restMateriaMockMvc
            .perform(get("/api/materias?sort=id,desc"))
    ...
    public void getMateria() throws Exception {
        ...
        // Get the materia
        restMateriaMockMvc
            .perform(get("/api/materias/{id}", materia.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingMateria() throws Exception {
        // Get the materia
        restMateriaMockMvc.perform(get("/api/materias/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateMateria() throws Exception {
        ...
        restMateriaMockMvc
            .perform(
                put("/api/materias").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedMateria))
            )
            .andExpect(status().isOk());
    ...
    public void updateNonExistingMateria() throws Exception {
        ...
        restMateriaMockMvc
            .perform(put("/api/materias").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(materia)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteMateria() throws Exception {
        ...
        // Delete the materia
        restMateriaMockMvc
            .perform(delete("/api/materias/{id}", materia.getId()).accept(MediaType.APPLICATION_JSON))
